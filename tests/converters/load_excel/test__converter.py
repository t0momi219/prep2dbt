...
class TestLoadExcelConverter:
    ...
    def test__validate(self, in_dict, expected_error):
        try:
            LoadExcelConverter.validate(in_dict)
    ...
    def test__perform_generate_graph(self):
        ...
        actual = LoadExcelConverter.perform_generate_graph(in_dict)
    ...
    def test__perform_calculate_columns(self):
        ...
        actual = LoadExcelConverter.perform_calculate_columns(
    ...
    def test__perform_generate_dbt_models(self, mocker):
        ...
        actual = LoadExcelConverter.perform_generate_dbt_models(
            "87818c7b-aea2-47c0-90ec-58638350bbc3", in_graph
        )
